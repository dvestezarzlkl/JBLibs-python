...
TXT_SSH_MNG_024 = "No existing and enabled SSH keys were found for user {name}."
...
TXT_KEY_IMPORT_HEADER_TXT = "Import public SSH key"
TXT_INP_PUB_KEY_STREAM = "Enter public key (single line, starts with ssh-rsa or ssh-ed25519): "
TXT_INP_PUB_KEY_STREAM_INLINE_TXT = " (paste the entire key in one line) "
TXT_INP_PUB_KEY_STREAM_FORMAT_ERR = "Invalid public key format. Key must start with 'ssh-rsa' or 'ssh-ed25519'."
TXT_INP_PUB_KEY_SUCC_IMPORT = "Public key imported successfully for user {name} - name: {cert}."
TXT_INP_PUB_KEY_KEYNAME = "Enter key name"
TXT_INP_PUB_KEY_KEYNAME_ERR = "Invalid key name. Only letters, digits, underscores, and hyphens are allowed."

TXT_UART_ERR_LEN_MIN = "[ERROR] Length must be greater than 0."
TXT_UART_ERR_LEN_MAX = "[ERROR] Length is too large (max 1024)."
TXT_UART_ERR_REPEAT_MIN = "[ERROR] Repeat count must be greater than 0."
TXT_UART_ERR_REPEAT_MAX = "[ERROR] Repeat count is too large (max 100)."
TXT_UART_OK_HASH_CONTENT = "Hash and content match."
TXT_UART_FAIL_HASH_CONTENT = "Hash OK - CONTENT ERROR."
TXT_UART_FAIL_HASH = "Hash ERROR {received_hash} != {computed_hash}"
TXT_UART_FAIL_INVALID_RESPONSE = "Invalid response format: {line}"
TXT_UART_TIMEOUT = "No response received."
TXT_UART_ERR_MISSING_PYSERIAL = "[ERROR] Missing pyserial library. Install it with: pip install pyserial"
TXT_UART_ERR_OPEN_PORT = "[ERROR] Cannot open port {port}: {err}"
TXT_UART_SEND_STATUS = "[SEND {attempt}] bytes: {length} (hash: {hash})"
...
TXT_UART_RECEIVER_ACTIVE = "[RECEIVER] Receiver mode active. Waiting for messages..."
TXT_UART_RECEIVER_EXIT_HINT = "[RECEIVER] Stop with Ctrl+C"
TXT_UART_RECEIVER_STOPPED = "[RECEIVER] Stopped by user."
TXT_UART_IN_BYTES_RECEIVED = "[IN ] bytes received: {length}"
TXT_UART_OUT_BYTES_SENT = "[OUT] bytes sent: {length}, hash: {hash}"
TXT_UART_SENDER_TITLE = "********** Serial tester - Sender {version} by dvestezar.cz **********"
TXT_UART_HEADER_CMD_HINT = "Enter command 'test[<len>][n<repeat>]' or 'exit'."
TXT_UART_HEADER_HELP_HINT = "Type 'help' for help."
TXT_UART_HEADER_RCV_HINT = "Type 'rcv' to start receiver mode."
TXT_UART_HELP_TITLE = "\n*** Available commands: ***"
TXT_UART_HELP_SYNTAX = "  test              -> syntax = test[<len>][n<repeat>]"
TXT_UART_HELP_TEST_DEFAULT = "  - test              -> sends 64 characters (default test)"
TXT_UART_HELP_TEST_LEN = "  - test120           -> sends 120 characters"
TXT_UART_HELP_TEST_REPEAT = "  - test80n5          -> sends 80 characters, repeats 5x"
TXT_UART_HELP_TEST_REPEAT_DEFAULT = "  - testn3            -> sends 64 characters, repeats 3x"
TXT_UART_HELP_RCV = "  rcv               -> starts receiver mode"
TXT_UART_HELP_CLS = "  cls               -> clears screen"
TXT_UART_HELP_EXIT = "  exit              -> exits script"
TXT_UART_HELP_HELP = "  help              -> shows this overview\n"
TXT_UART_SWITCH_TO_RCV = "--- >>> Starting receiver mode..."
TXT_UART_BACK_TO_TX = "--- <<< Returning to transmitter mode."
TXT_UART_SENDING_TEST = "[INFO] Sending test messages ({length} characters, {repeat}x)..."
TXT_UART_PRESS_ENTER = "Press ENTER to continue..."
TXT_UART_STOPPED_BY_USER = "\n[INFO] Stopped by user."
TXT_UART_ERR_OCCURRED = "[ERROR] Error occurred: {err}"
TXT_UART_ERR_CLOSE_PORT = "[ERROR] Cannot close port: {err}"
TXT_UART_ARG_DESCRIPTION = "Sends test messages to a serial port and verifies responses."
TXT_UART_ARG_PORT_HELP = "Serial port, e.g. /dev/ttyS3"
TXT_UART_ARG_BAUDRATE_HELP = "Baud rate (default: {baudrate})"
TXT_UART_ARG_RECEIVER_HELP = "Run as receiver (message recipient)"
TXT_UART_ARG_PARITY_HELP = "Parity: N none, E even, O odd, M mark, S space (default: N)"
TXT_UART_ARG_BYTESIZE_HELP = "Data bits (default: {bytesize})"
TXT_UART_ARG_STOPBITS_HELP = "Stop bits (default: {stopbits})"
TXT_UART_ARG_TIMEOUT_HELP = "Serial read timeout in seconds (default: {timeout})"
TXT_UART_EXITING = "Exiting."
